...
Compiled: 2026-08-02
Purpose: Deep technical analysis of the papers I have read in full (extracted to `/tmp/opencode/*.txt`). Formulations, key hyperparameters, benchmark numbers, and UR5 hardware details, for thesis writing.
...
## 1. PGMORL — Prediction-Guided Multi-Objective RL (13) — DEEP
...
## 2. Envelope MOQ-Learning (16) — DEEP
...
## 3. MO-MPO — Distributional view of MO Policy Optimization (02) — DEEP
...
## 4. GCR-PPO — Scalable MO Robot RL via Gradient Conflict Resolution (08) — DEEP
...
## 5. Demonstration-Enhanced Adaptable MO Robot Navigation (11) — DEEP
...
## 7. 3D Diffusion Policy / DP3 (04) — DEEP
...
## 8. POVNav — Pareto-Optimal Visual Navigation (14) — DEEP
...
2. **20-aloha-unleashed** — Diffusion Policy recipe details + bimanual arms (closest to dual-UR5).
3. **05-aloha / 06-mobile-aloha** — ACT baseline details for comparison.
